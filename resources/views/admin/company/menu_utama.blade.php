            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form role="form" autocomplete="off" action="{{route('company.updatemenu',1)}}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="Lomba">Email Perusahaan <span
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="Lomba">Nomor Perusahaan <span
                                                    style="color: red">*</span></label>
