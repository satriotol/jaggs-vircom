        ...
        <div class="row">
            <div class="col-md-12 mt-5 mb-5 ">
                ...
                <h1 class="txt-dark-blue mt-5" data-aos="fade-left" data-aos-duration="1000">APA ITU YOUNG STAR
                    CHAMPIONSHIP</h1>
                <P class="deskripsi txt-dark-blue mt-4 " data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                    {{$company->description}}

                </P>
                <h1 class="txt-dark-blue mt-4" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true">Untuk Siapa ?</h1>
                <P class="deskripsi txt-dark-blue mt-4" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                    {{$company->apa_kata_mereka}}
                </P>
                <h1 class="txt-dark-blue" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true">Visi & Misi</h1>
                <h1 class="txt-dark-blue deskripsi mt-4" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true">Visi</h1>
                <P class="deskripsi txt-dark-blue mt-4" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                    {!!$company->vision!!}
                </P>
                <h1 class="txt-dark-blue deskripsi mt-4" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true">Misi</h1>
                <P class="deskripsi txt-dark-blue mt-4" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                    {!!$company->mission!!}
                </P>
            </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                    <img src="{{asset('storage/'.$team->image)}}" alt="" class="foto-anggota " width="50%" height="auto">
